...
class ConsultaMesController extends Controller
{
    ...
    public function Mes(Request $request) 
    {
		...
		$ListaMes=DB::table('HistoricoLiquidacion')->where('Id_Funcionario', $Id_Funcionario)->where('Ano', $Anio)->distinct()->get('Mes');

		$MesActual=DB::table('Liquidacion')->where('Id_Funcionario', $Id_Funcionario);
