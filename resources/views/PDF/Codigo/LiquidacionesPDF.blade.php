...
$resultado = DB::connection('codigo')->table('HistoricoLiquidacion')
...
$resultado01 = DB::connection('codigo')->table('HistoricoMovLiquidacion')
...
$consulta02 = DB::connection('codigo')->table('HistoricoMovLiquidacion')
->leftJoin('Haberes', 'HistoricoMovLiquidacion.Id_HaberDcto', '=', 'Haberes.Id_Haber')
->leftJoin('FichaFuncionario', 'HistoricoMovLiquidacion.Id_Funcionario', '=', 'FichaFuncionario.Id_Funcionario')
...
$z=0;
    ...
    $resultado0 = DB::connection('codigo')->table('Municipalidad')->first();
