...

$PlanillaSuplementaria = DB::table('FichaFuncionario')
->leftjoin('PlanillaSuplementaria', 'FichaFuncionario.Id_Funcionario', '=', 'PlanillaSuplementaria.Id_Funcionario')
->where('FichaFuncionario.Rut', '=', $rut)
->where('PlanillaSuplementaria.Mes', '=', $mes)
->where('PlanillaSuplementaria.Ano', '=', $ano)
->get();

$TotalMontoJubilacion=0;
$TotalMontoSalud=0;
$TotalImpuestoUnico=0;
$TotalTotalImponible=0;
$TotalImponible=0;
...
$Liquido1=0;
   ...
   foreach($PlanillaSuplementaria as $row)
      {
        $TotalMontoJubilacion=$TotalMontoJubilacion+$row->MontoJubilacion;
        $TotalMontoSalud=$TotalMontoSalud+$row->MontoSalud;
        $TotalImpuestoUnico=$TotalImpuestoUnico+$row->ImpuestoUnico;
        $TotalTotalImponible=$TotalTotalImponible+$row->TotalImponible;
        $TotalImponible=$TotalImponible+$row->TotalImponible;
        $MontoSisEmpleador=$MontoSisEmpleador+$row->MontoSisEmpleador;
      }

$TotalImposiciones=$TotalMontoJubilacion+$TotalMontoSalud;
$TotalHaberes=$TotalMontoJubilacion+$TotalMontoSalud+$TotalTotalImponible;


$TotalDctos1=$TotalMontoJubilacion+$TotalMontoSalud+$TotalImpuestoUnico;


$Liquido1= $TotalHaberes-$TotalDctos1;

$MontoSisEmpleador=number_format($MontoSisEmpleador,0,".",".");
$TotalTotalImponible=number_format($TotalTotalImponible,0,".",".");
$TotalImpuestoUnico=number_format($TotalImpuestoUnico,0,".",".");
$TotalMontoSalud=number_format($TotalMontoSalud,0,".",".");
$TotalMontoJubilacion=number_format($TotalMontoJubilacion,0,".",".");
$TotalImponible=number_format($TotalImponible,0,".",".");
$TotalHaberes=number_format($TotalHaberes,0,".",".");
$TotalImposiciones=number_format($TotalImposiciones,0,".",".");
$TotalDctos=number_format($TotalDctos1,0,".",".");




$ListaHaberes = DB::table('MovimientoPlanillaSuple')
->leftjoin('FichaFuncionario', 'MovimientoPlanillaSuple.Id_Funcionario', '=', 'FichaFuncionario.Id_Funcionario')
->leftjoin('Haberes', 'MovimientoPlanillaSuple.Id_HaberDcto', '=', 'Haberes.Id_Haber')
->where('FichaFuncionario.Rut', '=', $rut)
->where('MovimientoPlanillaSuple.Mes', '=', $mes)
->where('MovimientoPlanillaSuple.Ano', '=', $ano)
->get();

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////Fin Planilla Suplementaria////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            <tr>
                <td>
                    <div id="TablaIzq"> 
                        <table width="100%" border="0" cellpadding="2" id="">
                <?php
                    foreach($ListaHaberes as $row)
                        {   ?>
                            <tr>
                                <td><?php echo $row->HaberDescripcion; ?></td>
                                <td>$<?php echo number_format($row->Valor_HaberDcto,0,".","."); ?></td>
                            </tr>
          ...
          <td>
            <div id="TablaDer"> 
              <table width="100%" border="0" cellpadding="2" id="">
                <tr>
                  ...
                  <td><strong>$<?php echo $TotalMontoJubilacion; ?></strong></td>
                </tr>
                <tr>
                  <td>SALUD</td>
                  <td>$<?php echo $TotalMontoSalud; ?></td>
                </tr>
                <tr>
                  <td>TOTAL IMPOSICIONES </td>
                  <td>$<?php echo $TotalImposiciones; ?></td>
                </tr>
                <tr>
                <?php 
            if($TotalImpuestoUnico !=0)
                { ?>
                  ...
                  <td>$<?php echo $TotalImpuestoUnico; ?></td>
        <?php   }
            else
                { ?>
                    <td>IMPUESTO UNICO </td>
            ...
            <div id="TablaIzq"> 
              <table width="100%" border="0" cellpadding="2" id="">
                ...
                <tr>
                  ...
                  <td><strong>$<?php echo $TotalImponible; ?></strong></td></td>
                </tr>
                <tr>
                  <td><strong>BASE TRIBUTABLE</strong></td>
                  <td><strong>$<?php echo $TotalImponible; ?></strong></td>
                </tr>
              </table>
            </div>
          </td>
...
<?php 
    ...
    <center><h3>Su Liquidación no se encuentra disponible, diríjase a dirección de gestión de personas.   <?php echo $mes; ?></h3></center>
<?php }
?>